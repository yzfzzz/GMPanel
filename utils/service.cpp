...
namespace monitor {
bool Service::queryDataInfo(std::string account_num, std::string machine_name) {
...
bool Service::login(std::string account_num, std::string pwd) {
...
bool Service::signup(std::string pwd) {
